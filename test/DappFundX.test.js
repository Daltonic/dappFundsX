    ...
    describe('Charity Mgt.', () => {
      ...
      describe('Success', () => {
        ...
        it('Should confirm charity update', async () => {
          ...
          const newName = 'My Updated Charity'
          const newAmount = 2.5
      ...
      describe('Failures', () => {
        it('Should confirm charity creation failures', async () => {
          ...
          ).to.be.rejectedWith('Amount cannot be zero')
        })
  ...
  describe('Donation Mgt.', () => {
    ...
    describe('Success', () => {
      it('Should confirm charity donations', async () => {
        ...
        result = await contract.getSupperters(id)
        expect(result).to.have.lengthOf(1)
      })
